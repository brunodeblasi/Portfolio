---
title: "Who is Bruno Gall De Blasi?"
description: "Journalist and aspiring data scientist"
type: "sobre"
showDate: false
showWordCount: false
...
![Bruno Gall De Blasi covering ENEX 2025 in Dubai](featured.jpg "Bruno Gall De Blasi covering ENEX 2025 in Dubai")
...
{{< keywordList >}}
{{< keyword icon="pencil" >}}Writing and editing{{< /keyword >}}
{{< keyword icon="google" >}}SEO{{< /keyword >}}
{{< keyword icon="edit" >}}Content strategy{{< /keyword >}}
{{< keyword icon="search" >}}Investigative reporting{{< /keyword >}}
{{< keyword icon="image" >}}Photography and audiovisual production{{< /keyword >}}
{{< keyword icon="globe" >}}Media relations{{< /keyword >}}
{{< keyword icon="comment" >}}Team management{{< /keyword >}}
{{< /keywordList >}}
...
{{< keyword icon="dev" >}}HTML & CSS{{< /keyword >}}
{{< keyword icon="pgpkey" >}}Data analysis and visualization{{< /keyword >}}
{{< keyword icon="google" >}}Google Analytics{{< /keyword >}}
{{< keyword icon="sun" >}}Metrics and KPIs{{< /keyword >}}
{{< /keywordList >}}

### Languages

{{< keywordList >}}
{{< keyword icon="language" >}}English (fluent){{< /keyword >}}
{{< keyword icon="language" >}}Spanish (intermediate){{< /keyword >}}
{{< keyword icon="language" >}}Chinese (basic){{< /keyword >}}
{{< /keywordList >}}
...
{{< timelineItem icon="bars" header="Editor" badge="Nov/2024 – present" subheader="Canaltech (Magazine Luiza)" >}}
...
{{< timelineItem icon="bars" header="Reporter" badge="Jan/2024 – Oct/2024" subheader="Canaltech" >}}
...
{{< timelineItem icon="bars" header="Freelance Reporter" badge="Oct/2023 – Jan/2024" subheader="Giz Brasil" >}}
Coverage of technology, gadgets, and innovation. News production and feature reporting.
{{< /timelineItem >}}

{{< timelineItem icon="bars" header="Freelance Writer" badge="Jun/2023 – Oct/2023" subheader="TechTudo (Editora Globo)" >}}
Writing SEO-focused evergreen content on technology and entertainment for TechTudo.
{{< /timelineItem >}}

{{< timelineItem icon="bars" header="Writer" badge="Mar/2023 – Oct/2023" subheader="Approach Comunicação" >}}
...
{{< timelineItem icon="bars" header="Freelance Writer" badge="Apr/2023 – 2023" subheader="Olhar Digital" >}}
Writing SEO-focused evergreen content on technology and entertainment for Olhar Digital.
{{< /timelineItem >}}

{{< timelineItem icon="bars" header="Reporter" badge="Feb/2020 – Mar/2023" subheader="Tecnoblog" >}}
...
{{< timelineItem icon="bars" header="Intern" badge="Feb/2018 – Oct/2019" subheader="TechTudo (Editora Globo)" >}}
...
{{< timelineItem icon="bars" header="Monitor" badge="Oct/2018 – Dec/2019" subheader="Agência UVA" >}}
...
{{< timelineItem icon="bars" header="Intern and Editor" badge="Apr/2017 – Jan/2018" subheader="Myclipp" >}}
News clipping and monitoring for institutions such as Banco Central do Brasil, Banco do Brasil, and Eletrobras.
{{< /timelineItem >}}

{{< timelineItem icon="bars" header="Writer" badge="Jul/2016 – Jan/2018" subheader="iHelp BR" >}}
...
{{< timelineItem icon="graduation-cap" header="Bachelor's Degree in Computer Science" badge="2026 – 2029" subheader="Descomplica" >}}
Graduate degree in progress, with a focus on data science and Full Stack Development.
{{< /timelineItem >}}

{{< timelineItem icon="graduation-cap" header="MBA in Digital Strategic Marketing" badge="2022 – 2023" subheader="Universidade Veiga de Almeida" >}}
Specialization in digital strategy, SEO, and analytics.
{{< /timelineItem >}}

{{< timelineItem icon="graduation-cap" header="Bachelor's Degree in Journalism" badge="2016 – 2019" subheader="Universidade Veiga de Almeida" >}}
...
{{< timelineItem icon="graduation-cap" header="Technical High School in Mechatronics" badge="2011 – 2013" subheader="Escola Técnica Electra" >}}
...
{{< keyword >}}Science Communication (Fiocruz){{< /keyword >}}
{{< keyword >}}Photography{{< /keyword >}}
{{< keyword >}}Audiovisual Production{{< /keyword >}}
{{< /keywordList >}}
